...
interface Props extends ViewProps {
    filters: BikeTagType[],
    onFilterChange: (filter: BikeTagType) => void
}
...
export const TagFilter: FC<Props> = ({
    ...
    const tags: BikeTagType[] = useAppSelector(state => state.global.staticState?.tag_available ?? []);
            ...
            >
                <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                        ...
                        {
                            ["ALL", ...tags].map((item, i) => {
                                const isSelected = (i === 0 && filters.length === 0) || filters.includes(item as BikeTagType);
